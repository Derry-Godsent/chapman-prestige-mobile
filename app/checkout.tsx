...
import { DisplayText, PrimaryButton, StatusPill, useChapmanStyles, ChapmanPalette } from "@/components/chapman-ui";
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.requestCard}>
            <View style={styles.requestHeading}>
              <View style={styles.requestIcon}><Ionicons name="calendar-outline" size={20} color={palette.accent} /></View>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  {pickupArea === item && <Ionicons name="checkmark" size={20} color={palette.accent} />}
                </TouchableOpacity>
              )}
            />
          </View>
...
const makeStyles = (palette: ChapmanPalette) => StyleSheet.create({
  ...
  requestCard: { padding: 16, borderRadius: 20, backgroundColor: palette.surface, borderWidth: 1, borderColor: "#DCE6D9", gap: 12 }, 
  ...
  datePickerButton: { minHeight: 48, borderRadius: 12, borderWidth: 1, borderColor: palette.border, backgroundColor: palette.surface, flexDirection: "row", alignItems: "center", paddingHorizontal: 12, gap: 10 },
  ...
  locationShareCardReady: { backgroundColor: "#EFF9F0", borderColor: palette.accentBorder }, 
  locationShareAction: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 8 }, 
  locationShareActionText: { color: palette.accent, fontFamily: "Inter_700Bold", fontSize: 13 },
  ...
  locationSuccessCoords: { color: palette.accent, fontFamily: "Inter_600SemiBold", fontSize: 11 },
  locationSuccessMeta: { color: palette.muted, fontFamily: "Inter_400Regular", fontSize: 9 },
  locationRemove: { padding: 5 },
  compactInput: { minHeight: 44, borderRadius: 12, borderWidth: 1, borderColor: palette.border, backgroundColor: palette.surface, color: palette.ink, fontFamily: "Inter_500Medium", fontSize: 13, paddingHorizontal: 12, marginTop: 8 }, 
  input: { minHeight: 48, borderRadius: 12, borderWidth: 1, borderColor: palette.border, backgroundColor: palette.surface, color: palette.ink, fontFamily: "Inter_500Medium", fontSize: 13, paddingHorizontal: 12, marginTop: 4 }, 
  noteInput: { minHeight: 74, paddingTop: 11, textAlignVertical: "top" }, 
  windowGrid: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginTop: 4 }, 
  window: { width: "48.5%", minHeight: 38, paddingHorizontal: 8, borderRadius: 12, borderWidth: 1, borderColor: palette.border, backgroundColor: palette.surface, alignItems: "center", justifyContent: "center" }, 
  ...
  finalValue: { color: palette.accent, fontFamily: "PlusJakartaSans_800ExtraBold", fontSize: 20 }, 
  estimateHelp: { color: "#818A9B", fontFamily: "Inter_400Regular", fontSize: 10, lineHeight: 14 },
  paymentSection: { padding: 16, borderRadius: 20, backgroundColor: palette.surface, borderWidth: 1, borderColor: palette.border, gap: 9 }, 
  ...
  paymentIcon: { width: 34, height: 34, borderRadius: 11, backgroundColor: palette.chipBlue, alignItems: "center", justifyContent: "center" }, 
  ...
  error: { minHeight: 48, padding: 12, borderRadius: 15, backgroundColor: palette.chipRed, flexDirection: "row", alignItems: "center", gap: 9 }, 
  ...
  modalContent: { backgroundColor: palette.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, maxHeight: "80%" },
