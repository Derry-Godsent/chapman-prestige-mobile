  ...
  const startLocation = async () => {
    ...
    try {
      ...
      if (permission.status !== "granted") {
        // The phone only asks once. After a no, the customer has to change it in
        // their own settings, so take them there rather than doing nothing.
        if (permission.canAskAgain === false) {
          setLocationLabel("Location is switched off for Chapman. Opening your phone's settings.");
