...
const stepForStatus: Record<string, number> = { "quote-requested": 1, pending: 1, "under_review": 1, "needs_customer_confirmation": 1, "pending-review": 1, confirmed: 1, assigned: 2, "en-route": 3, "in-progress": 3, completed: 4 };
...
function requestStatusLabel(status: MobileLaundryRequest["request_status"]) {
  ...
  if (status === "confirmed") return "date accepted";
      ...
      <View style={styles.page}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.lead}>
            ...
            <DisplayText style={styles.leadTitle}>{requestInReview ? "We have your request." : "Your date is confirmed."}</DisplayText>
            <BodyText style={styles.leadBody}>{liveAwaitingResponse ? "Chapman has proposed a date. Please accept it or ask for another option." : requestInReview ? "Chapman will check the pickup details and keep you updated here." : "Your service date has your approval. We will share each practical update here."}</BodyText>
