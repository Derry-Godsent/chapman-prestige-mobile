      ...
      <View style={styles.page}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.lead}>
            <View style={[styles.leadIcon, requestInReview && styles.leadIconQuote, isDeclined && styles.leadIconDeclined]}><Ionicons name={isDeclined ? "close" : requestInReview ? "document-text-outline" : "checkmark"} size={26} color="#FFFFFF" /></View>
            <StatusPill label={status} tone={isDeclined ? "red" : requestInReview ? "orange" : "green"} />
            <DisplayText style={styles.leadTitle}>{isDeclined ? "This request was declined." : requestInReview ? "We have your request." : "Your date is confirmed."}</DisplayText>
            <BodyText style={styles.leadBody}>{isDeclined ? "Chapman could not approve this Laundry request. Use Message Chapman for a clear next step or another service option." : liveAwaitingResponse ? "Chapman has proposed a date. Please accept it or ask for another option." : requestInReview ? "Chapman will check the pickup details and keep you updated here." : "Your service date has your approval. We will share each practical update here."}</BodyText>
