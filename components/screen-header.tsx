...
const makeStyles = (palette: ChapmanPalette) => StyleSheet.create({ header: { minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, back: { width: 42, height: 42, borderRadius: 14, backgroundColor: palette.surface, borderWidth: 1, borderColor: palette.border, alignItems: "center", justifyContent: "center" }, titleWrap: { alignItems: "center", flex: 1, paddingHorizontal: 8 }, title: { color: palette.ink, fontFamily: "Inter_700Bold", fontSize: 15 }, subtitle: { color: palette.muted, fontFamily: "Inter_400Regular", fontSize: 10, marginTop: 1 }, rightGap: { width: 42 } });
