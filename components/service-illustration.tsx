...
const makeStyles = (palette: ChapmanPalette) => StyleSheet.create({ scene: { width: "100%", overflow: "hidden", alignItems: "center", justifyContent: "center" }, sceneDark: { backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 28 }, scenePortrait: { borderRadius: 26, backgroundColor: palette.canvas }, sceneImage: { width: "100%", height: "100%" }, container: { padding: 12, paddingBottom: 14, borderRadius: 24, backgroundColor: "#EDF3FF", overflow: "hidden" }, caption: { flexDirection: "row", alignItems: "flex-start", gap: 8, paddingHorizontal: 5, paddingTop: 1 }, dot: { width: 7, height: 7, borderRadius: 4, backgroundColor: palette.blue, marginTop: 5 }, captionText: { flex: 1, color: "#435069", fontFamily: "Inter_500Medium", fontSize: 12, lineHeight: 18 } });
